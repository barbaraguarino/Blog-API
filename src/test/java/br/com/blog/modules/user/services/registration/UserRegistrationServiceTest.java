...
class UserRegistrationServiceTest {
    ...
    class RegisterWithGoogle {
        ...
        @Test
        @DisplayName("Deve lançar ExternalProviderAuthException quando token for nulo")
        void shouldThrowExternalProviderAuthWhenTokenIsNull(){
            ...
            assertThrows(ExternalProviderAuthException.class, () -> userRegistrationService.registerWithGoogle(requestDTO));
        }
